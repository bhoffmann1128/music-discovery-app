...
export default async function handler(req, res){
    ...
    let filename = senddata.username + "-" + body.id + "." + "jpeg";
    let key = "artists/" + senddata.username + "/images/" + filename;

    senddata.key = key;
    senddata.action = "PUT";
    senddata.metadata = null;
    ...
    res.status(200).json({result: result, key: key, filename: filename});
}