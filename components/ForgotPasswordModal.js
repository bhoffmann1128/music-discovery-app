...
export default function ForgotPasswordModal({show, onClose, resetSubmit, success}){
            ...
            <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div className="fixed z-10 inset-0 overflow-y-auto">
                    <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                        ...
                        <h3 className="modal-header text-sm italic mb-2 leading-6 font-medium p-4 flex items-center" id="modal-title"><FaLock className="mr-2" /> password reset</h3>
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 w-full text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2 text-center">
                                        {!success && (
                                            <>
                                        <h2 className="text-2xl">enter your email to reset your password</h2>
                                        ...
                                        {success && (
                                            <h2 className="text-2xl">check your email to finish resettting your password</h2>
                                        )}
                                    </div>
