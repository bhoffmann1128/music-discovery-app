...
export default function ContactFormModal({show, onClose, contactSubmit, success}){
            ...
            <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div className="fixed z-10 inset-0 overflow-y-auto">
                    <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                        ...
                        <h3 className="modal-header text-sm italic mb-2 leading-6 font-medium p-4 flex items-center" id="modal-title"><FaEnvelope className="mr-2" /> contact us</h3>
