export default function PaymentResultModal({show, onClose, onCancel, onSubmit, type, errormessage}){
                                ...
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 w-full text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        {type == "error" && (
                                            ...
                                            <div className="text-center mb-4 text-2xl">
                                                <h2>payment error</h2>
                                                <p className="text-red-700"><em>{errormessage}</em></p>
                                            </div>
                                            <div className="mt-2 text-center flex items-center justify-center">
                                                <div className="text-center flex items-center">
